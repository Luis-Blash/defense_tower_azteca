...
export const dataGuiModalsBasic = (object = null, limit = 10) => {
	...
	folderGui.add(object.scale, "x", 0, 10).step(0.01).name("Scale X");
	folderGui.add(object.scale, "y", 0, 10).step(0.01).name("Scale Y");
	folderGui.add(object.scale, "z", 0, 10).step(0.01).name("Scale Z");
};
